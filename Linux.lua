...
Linux.CurrentAccent = "Red"
Linux.SelectedAccent = "Red"
Linux.Accents = {
...
Linux.FrameTransparency = 0.80
Linux.FrameColor = Color3.fromRGB(40, 40, 43)
Linux.MainFrameColor = Color3.fromRGB(9, 9, 9)
...
function Linux.LoadAccentSettings()
    local success, result = pcall(function()
        if readfile and isfile(Linux.ConfigFolder .. "/accent.json") then
            ...
            Linux.CurrentAccent = accentData.Accent or "Red"
    ...
    local success, result = pcall(function()
        if listfiles and isfolder(Linux.ConfigFolder) then
            ...
            for _, file in pairs(files) do
                ...
                if configName and configName ~= "autoload" and configName ~= "privacy" and configName ~= "accent" then
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            if CurrentTab and Tabs[CurrentTab] then
                ...
                if oldTab.Icon then
                    oldTab.Icon.ImageColor3 = Color3.fromRGB(210, 210, 210)
                end
            ...
            TabBtn.BackgroundColor3 = Color3.fromRGB(30, 30, 32)
            ...
            if TabIcon then
                TabIcon.ImageColor3 = Color3.fromRGB(210, 210, 210)
            end
        ...
        function TabElements.Button(config)
            ...
            if CollapseEnable then
                ...
                CollapseGradientLine = Linux.Instance("Frame", {
                    Parent = BtnFrame,
                    BackgroundColor3 = Linux.Accents[Linux.CurrentAccent],
                    Size = DefaultOpen and UDim2.new(1, -10, 0, 2) or UDim2.new(0, 0, 0, 2),
                ...
                task.defer(function()
                    ...
                    local buttonLayoutOrder = BtnFrame.LayoutOrder
                    local elementsToHide = 0
                    
                    local sortedElements = {}
                    for _, elementData in pairs(currentTab.Elements) do
                        if elementData.Instance and elementData.Instance.Parent and elementData.Instance.LayoutOrder then
                            table.insert(sortedElements, {
                                Instance = elementData.Instance,
                                LayoutOrder = elementData.Instance.LayoutOrder
                            })
                        end
                    end
                    ...
                    for _, elementInfo in pairs(sortedElements) do
                        if elementInfo.LayoutOrder > buttonLayoutOrder and elementsToHide < CollapseCount then
                            table.insert(targetElements, elementInfo.Instance)
                    ...
                    for i, element in pairs(targetElements) do
                        if element and element.Parent then
                            element.Visible = not IsCollapsed
                        end
                    end
                end)
            end
